...
class AppTablesDataV1(QDialog):
    ...
    def refreshAllTablesV1(self):
        ...
        self.refreshTable(self.ui.label_ages, self.ui.tableAges,
                          "SELECT age, numSp FROM LesAgesSportifs")
        # TODO 1.5b : ajouter l'affichage des éléments de la vue LesNbsEquipiers après l'avoir créée
        self.refreshTable(self.ui.label_nb_equipiers, self.ui.tableNbEquipiers,
