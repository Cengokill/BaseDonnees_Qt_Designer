...
from actions.action_fct_partie_3_2 import AppFctPartie3_2
...
class AppWindow(QMainWindow):
    ...
    # ajout des fenetres (répertoire gui) et les actions (répertoire actions) correspondant aux 2 items de la partie 2.
